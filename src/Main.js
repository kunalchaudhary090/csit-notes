  ...
  const sections = [
    {
      ...
      items: [
        ...
        { id: 2, rank: '#2', color: 'bg-purple-200', subject: 'OOP', chapters: 8, path: '/second-semester/oop', img: 'https://i.ibb.co/PF4Jvbf/oop.png' },
        ...
        { id: 4, rank: '#4', color: 'bg-blue-200', subject: 'Mathematics II', chapters: 10, path: '/second-semester/mathsI', img: 'https://i.ibb.co/qWkMMsh/mathematics-II.png' },
        { id: 4, rank: '#5', color: 'bg-orange-200', subject: 'Statistics I', chapters: 7, path: '/second-semester/statI', img: 'https://i.ibb.co/K07BLpT/statistics.png' },
      ],
    },
  ];
    ...
    <div className="bg-gray-50 min-h-screen">
      ...
      <div className="max-w-6xl mx-auto mt-10">
        {sections.map((section) => (
          <Section key={section.title} title={section.title} items={section.items} path={section.path}/>
        ))}
      </div>
    </div>
    <FooterComponent />
